...
let persona1 = new Persona("Alberto", "Galante");
console.log(persona1.nombre);
persona1.nombre = "Fernando";
console.log(persona1.nombre);
persona1.apellido = "Maquez";
console.log(persona1.apellido);
//console.log(persona1);
let persona2 = new Persona("Claudio", "Scaloni");
...
let persona3 = new Persona('Juan', 'Ferreyra');
...
let persona4 = new Persona('Marcos', "Vivas");
console.log(persona4.toString());
let persona5 = new Persona("Agustin", "Lagos");
