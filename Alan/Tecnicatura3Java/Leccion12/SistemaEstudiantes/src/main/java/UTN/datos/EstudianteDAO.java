...
public class EstudianteDAO {
    ...
    public  List<Estudiante> listarEstudiantes(){
        ...
        ResultSet rs; //obtenemos resultados de la base de datos
    ...
    public static void main (String[] args){
        ...
        var estudianteModificado = new Estudiante(1, "Juan Carlos", "Juarez", "55446872", "Juan@mail.com");
        ...
        //agregar estudiante
        //var nuevoEstudiante = new Estudiante("Carlos", "Lara", "54632257835", "carlos@mail.com");
