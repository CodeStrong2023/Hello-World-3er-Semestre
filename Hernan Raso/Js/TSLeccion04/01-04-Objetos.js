...
persona2.nombre = "Zoe";
persona2.direccion = "Espora 340";
persona2.telefono = "1146758876";
...
let padre = new Persona3("Nico", "Juarez", "juareznico@gmail.com");
padre.nombre = "nicolas"; //modificamos el nombre
padre.telefono = "114432453"; //una propiedad exclusiva del objeto padre
console.log(padre);
console.log(padre.nombreCompleto()); //Utilizamos la funcion 
let madre = new Persona3("Monica", "Correa", "correamonica@gmail.com");
console.log(madre);
...
console.log(persona4.nombreCompleto2("Lic.", "55345345"));
console.log(persona4.nombreCompleto2.call(persona5, "Ing.", "34673452"));

//metodo apply
let arreglo = ["Ing.", "435435"];
